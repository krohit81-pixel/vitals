...
**Current version:** see `version` in `package.json` (as of this writing, `1.1.4`).
...
src/
  app/
    ...
    (app)/                             — everything behind auth, wrapped by NavShell
      ...
      blood-pressure/                  — manual BP log (systolic/diastolic/notes),
                                          same add/edit/delete shape as weight/;
                                          window.print() for a tabular PDF export
